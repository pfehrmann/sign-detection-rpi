...
def identify_image(model, weights, image_path):
    ...
    rois = []
    i = 0
    window = ScalingSlidingWindow(processed, 32, 1, 0.65, lambda x: 1/(x+1))
...
#parse_arguments()
identify_image("model.prototxt", "model.caffemodel", "C:/Users/phili/Downloads/FullIJCNN2013/FullIJCNN2013/00001.ppm")