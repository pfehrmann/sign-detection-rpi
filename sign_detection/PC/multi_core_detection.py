...
from sign_detection.GTSDB.image_sources import CV2CameraImageSource
from sign_detection.GTSDB.roi_result_handlers import ViewHandler
...
def test():
    ...
    master = mpd.Master(create_detector, image_source, num_workers)
