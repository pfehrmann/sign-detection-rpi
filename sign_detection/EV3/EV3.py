...
class PID():
    ...
    def control_signal(self, actual_value):
        """
...
def port_motor_input(port_output):
    """
...
class EV3:
    ...
    def send_system_cmd(self, cmd, reply=True):
        """
    ...
    def _wait_for_system_reply(self, counter):
        """
...
if __name__ == "__main__":
    my_ev3 = EV3(protocol=USB, host='00:16:53:47:92:46')
    my_ev3.verbosity = 1
